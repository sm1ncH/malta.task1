...
<form action="final_form.php" method="POST">
        <h1>Terms and Conditions of Service – Agreement <br>
            <h5>[Note: Blue completed by admin / yellow information provided by client</h5></h1>
        
        <h3>REFERENCE NUMBER: ERDF.03.S1.Call 2.0231</h3>
        <kbd>This agreement is being entered into on the <span class="admin">/11/2021</span> between on the first part Yves De Barro, 
        ID Card Number 0138686M hereinafter referred to as "DB", <span class="user"><?php echo $name." ".$surname; ?></span> ID Card Number <span class="user"><?php echo $card_number; ?></span> and 
        <span class="user"><?php echo $company; ?></span> hereinafter referred to as the "CLIENT".</kbd>
        <p>Whereas
            ...
            <h3><span class="user"><?php echo $name." ".$surname; ?></span> 
                </h3>
            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td><input type="text" name="service" placeholder="The Service"></td>
                    </tr>
                    <tr>
                        <td><p>VAT Number</p> <!--Tu bo ona php koda--></td>
                        <td><span class="user"><?php echo $card_number; ?></span></td>
                    </tr>
                    <tr>
                        <td><p>BILLING address</p> </td>
                        <td><span class="user"><?php echo $address1; ?><br><?php echo $address2; ?><br><?php echo $town; ?><br><?php echo $post; ?></span></td>
                    </tr>
                    <tr>
                        <td><p>commencement Date </p></td>
                        <td><input type="text" name="commencement" placeholder="Commencement Date"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><span>€<input type="text" name="fee" placeholder="XX.XX"> excl VAT. [€<input type="text" name="vatfee" placeholder="XX.XX"> inclusive of VAT] This is based on estimation of works as per annexed Proposal Document </span></td>
                    </tr>
                    <tr>
                        <td><p>Payment terms</p></td>
                        <td><span>100% on completion [€<input type="text" name="paymentterm" placeholder="XX.XX">  inclusive of VAT]</span></td>
                    </tr>
                </table>
            </div>
